...
public class ExcelToConfig
{
    ...
    /// Excel文件读取路径
    /// </summary>
    public static string ExcelLaodPath= "Assets/ZMPackages/ZMUGUIPro/Localization/Resources/ExcelData/";
    /// <summary>
    /// 文件输出路径
    /// </summary>
    public static string OutPutPath = "ZMPackages/ZMUGUIPro/Localization/Resources/ExcelData/";
